...
urlpatterns = [
    ...
    path('api/v1/users/', UserAPIViews.as_view(), name='users'),
    path('api/v1/users/<int:pk>', UserInstanceAPIViews.as_view()),
    path('api/v1/messages/', MessageAPIViews.as_view(), name='messages'),
    # path('api/v1/messages/<int:pk>', MessageInstanceAPIViews.as_view()),
    path('api/v1/chatlist/', ChatAPIViews.as_view(), name='chatlist'),
